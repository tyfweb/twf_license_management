...
/// </summary>
public class ProductFeatureRepository : BaseRepository<ProductFeatureEntity>, IProductFeatureRepository
{ 
    public ProductFeatureRepository(LicensingDbContext context) : base(context)
    { 
    }
