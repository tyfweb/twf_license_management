...
/// </summary>
public class NotificationHistoryRepository : BaseRepository<NotificationHistoryEntity>, INotificationHistoryRepository
{
    DbSet<NotificationHistoryEntity> _notificationHistorySet;
    public NotificationHistoryRepository(LicensingDbContext dbContext) : base(dbContext)
    {
