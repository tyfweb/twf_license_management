...
/// </summary>
public class PostgreSqlNotificationTemplateRepository : BaseRepository<NotificationTemplate,NotificationTemplateEntity>, INotificationTemplateRepository
{
    public PostgreSqlNotificationTemplateRepository(PostgreSqlPostgreSqlLicensingDbContext context,IUserContext userContext) : base(context, userContext)
    {
    }
