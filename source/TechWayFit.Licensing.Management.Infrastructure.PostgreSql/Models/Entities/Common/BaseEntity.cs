...
using TechWayFit.Licensing.Management.Infrastructure.PostgreSql.Models.Entities.Tenant;

namespace TechWayFit.Licensing.Management.Infrastructure.PostgreSql.Models.Entities.Common;
...
public abstract class BaseEntity : AuditEntity
{
    ...
    /// </summary>
    public virtual TenantEntity Tenant { get; set; } = new TenantEntity();
