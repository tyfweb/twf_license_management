...
public class ProductFeatureController : BaseController
{
    ...
    public async Task<IActionResult> Create(Guid productId, ProductFeatureCreateEditViewModel model)
    {
        try
        {
            ...
            var newFeature = new ProductFeature
            {
                ...
                SupportFromVersion = !string.IsNullOrEmpty(model.SupportFromVersion) ? SemanticVersion.Parse(model.SupportFromVersion) : SemanticVersion.Default,
                SupportToVersion = !string.IsNullOrEmpty(model.SupportToVersion) ? SemanticVersion.Parse(model.SupportToVersion) : SemanticVersion.Default
            };
    ...
    public async Task<IActionResult> Edit(Guid productId, Guid featureId)
    {
        try
        {
            ...
            var viewModel = new ProductFeatureCreateEditViewModel
            {
                ...
                SupportFromVersion = feature.SupportFromVersion?.ToString() ?? "",
                SupportToVersion = feature.SupportToVersion?.ToString() ?? ""
            };
    ...
    public async Task<IActionResult> Edit(Guid productId, Guid featureId, ProductFeatureCreateEditViewModel model)
    {
        try
        {
            ...
            existingFeature.SupportFromVersion = !string.IsNullOrEmpty(model.SupportFromVersion) ? SemanticVersion.Parse(model.SupportFromVersion) : SemanticVersion.Default;
            existingFeature.SupportToVersion = !string.IsNullOrEmpty(model.SupportToVersion) ? SemanticVersion.Parse(model.SupportToVersion) : SemanticVersion.Default;
