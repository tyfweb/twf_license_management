...
namespace TechWayFit.Licensing.Management.Infrastructure.PostgreSql.Examples;
...
public class TenantAwareRepositoryExample
{
    ...
    public TenantAwareRepositoryExample(PostgreSqlPostgreSqlLicensingDbContext context)
    {
        _context = context;
    }
...
public class TenantAwareProductService
{
    ...
    public TenantAwareProductService(
        PostgreSqlPostgreSqlLicensingDbContext context,
