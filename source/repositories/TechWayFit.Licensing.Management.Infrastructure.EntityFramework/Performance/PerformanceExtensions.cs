...
namespace TechWayFit.Licensing.Management.Infrastructure.EntityFramework.Performance;

/// <summary>
/// Performance optimization extensions for Entity Framework infrastructure
/// Note: Provider-specific implementations should override ConfigureProviderPerformance
/// </summary>
public static class PerformanceExtensions
{
    /// <summary>
    /// Configure Entity Framework for optimal performance
    /// Override ConfigureProviderPerformance for provider-specific optimizations
    /// </summary>
    public static DbContextOptionsBuilder ConfigurePerformanceBase(
        this DbContextOptionsBuilder options,
        Action<DbContextOptionsBuilder>? configureProvider = null)
    {
        // Apply provider-specific performance configuration if provided
        configureProvider?.Invoke(options);

        // Common EF Core performance optimizations
        return options
