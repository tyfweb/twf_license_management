...
namespace TechWayFit.Licensing.Management.Infrastructure.EntityFramework.Repositories.Settings;

/// <summary>
/// Repository implementation for managing system settings
/// </summary>
public class EfCoreSettingRepository : BaseRepository<Setting,SettingEntity>, ISettingRepository
{
    public EfCoreSettingRepository(EfCoreLicensingDbContext context,IUserContext userContext) : base(context,userContext)
    {
    }
